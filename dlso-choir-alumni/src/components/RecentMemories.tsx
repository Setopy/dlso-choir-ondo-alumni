...
export default function RecentMemories() {
    ...
    return (
      <section className="container mx-auto px-6 py-12">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-gray-800 mb-4">Latest Shared Memories</h2>
        </div>
    ...
    return (
      <section className="container mx-auto px-6 py-12">
        <div className="text-center">
          <h2 className="text-3xl font-bold text-gray-800 mb-4">Memory Wall</h2>
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            No memories shared yet. Be the first to share a special moment from our choir family!
          </p>
          <Link 
            href="/memories/new"
            className="bg-orange-600 text-white px-8 py-3 rounded-lg hover:bg-orange-700 transition-colors font-semibold inline-block"
          >
  ...
  return (
    <section className="container mx-auto px-6 py-12">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <div className="text-right">
                    <p className="font-medium text-gray-700 text-xs">{memory.authorName || 'Anonymous'}</p>
                    <p className="text-xs text-gray-500">{formatDate(memory.createdAt)}</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* View All Memories Section */}
      <div className="bg-gradient-to-r from-amber-50 to-blue-50 rounded-xl p-8 text-center">
