      ...
      <div className="flex items-center space-x-3">
        <div className="flex items-center space-x-2">
          ...
          <div className="hidden sm:block">
            ...
            <p className="text-xs text-gray-600">DLSO Alumni</p>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-2">
          ...
          <button
            onClick={() => signOut()}
            className="flex items-center space-x-1 px-3 py-1 text-sm text-red-600 hover:text-red-700 hover:bg-red-50 rounded-lg"
          >
